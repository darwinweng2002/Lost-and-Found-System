...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="terms">
            ...
            <label>
                <input type="radio" name="agree" value="disagree"> Disagree
            </label>
        </div>
        <br>
                    <div class="row">
                        <div class="form-group">
                            <label for="" class="control-label">Upload supporting documents</label>
                            <label><i>(Upload Image: JPEG, JPG, PNG, SVG)</i></label>
